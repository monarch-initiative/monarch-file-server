...
Note this is a branch of the go-site indexer which can be found here
https://github.com/geneontology/go-site/blob/master/scripts/directory_indexer.py
...
Mount bucket to local filesystem
  mkdir /tmp/mnt/ || true
